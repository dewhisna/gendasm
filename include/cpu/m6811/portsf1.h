...
; Offset Pointers to Regs:
        .globl  pporta,pddra,pportg,pddrg
        .globl  pportb,pportf,pportc,pddrc
        ...
        .globl  padr4,pbprot
        .globl  popt2,poption,pcoprst,ppprog
        .globl  phprio,pinit,ptest1,pconfig
        .globl  pcsstrh,pcsctl,pcsgadr,pcsgsiz

; Direct Pointers to Regs:
        .globl  porta,ddra,portg,ddrg
        .globl  portb,portf,portc,ddrc
        ...
        .globl  adr4,bprot
        .globl  opt2,option,coprst,pprog
        .globl  hprio,init,test1,config
        .globl  csstrh,csctl,csgadr,csgsiz
