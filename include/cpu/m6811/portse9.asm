...
; Reserved:
        .blkb   1                       ; $0001 Reserved
ppioc	==		0x02
pioc::	.blkb	1						; $0002 Parallel I/O Control Register
pportc  ==      0x03
portc:: .blkb   1                       ; $0003 I/O Port C
pportb  ==      0x04
portb:: .blkb   1                       ; $0004 I/O Port B
pportcl	==		0x05
portcl::	.blkb	1					; $0005 I/O Port C Latched
; Reserved:
        .blkb   1                       ; $0006 Reserved
pddrc   ==      0x07
...
peprog	==		0x36
eprog::	.blkb	1						; $0036 EPROM Programming Control (MC68HC711E20 only)
; Reserved:
        .blkb   2                       ; $0037-0038 Reserved
poption ==      0x39
